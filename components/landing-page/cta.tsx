          ...
          <div className="relative z-10">
            <div className="max-w-xl mx-auto text-center">
              <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                ...
                <span className="font-bold">Shadow Overlay</span>
              </h2>
              <p className="mt-5 text-gray-300">
                Shadow Overlay is the best choice for Call Of Duty Warzone
                Cheats! Our cheats are loaded with features that will keep you
